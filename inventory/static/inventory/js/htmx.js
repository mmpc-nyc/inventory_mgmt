(function (e, t) {
    ...
    return function () {
        ...
        function k(e, t, r) {
            if (f(t)) {
                return {target: P().body, event: e, listener: t}
            } else {
        ...
        function J(e, t, r) {
            ...
            if (o) {
                ...
                ot(P().body, "htmx:oobErrorNoTarget", {content: t})
            }
            return e
        }
        ...
        function ue(e, t) {
            var r = X(e, "hx-select");
            if (r) {
                var n = P().createDocumentFragment();
        ...
        function xe(e) {
            ...
            while (r < e.length) {
                if (ge.exec(e.charAt(r))) {
                    var n = r;
                    while (pe.exec(e.charAt(r + 1))) {
                        r++
                    }
                    t.push(e.substr(n, r - n + 1))
                } else if (me.indexOf(e.charAt(r)) !== -1) {
                    var i = e.charAt(r);
                    var n = r;
                    r++;
        ...
        function be(e, t, r) {
            return ge.exec(e.charAt(0)) && e !== "true" && e !== "false" && e !== "this" && e !== r && t !== "."
        }
                    ...
                    if (a === "]") {
                        ...
                        if (n === 0) {
                            ...
                            try {
                                ...
                                ot(P().body, "htmx:syntax:error", {error: e, source: i});
                                return null
                            }
                        }
                    } else if (a === "[") {
        ...
        function qe(e, t, r, n) {
            ...
            i.timeout = setTimeout(function () {
                if (z(e) && i.cancelled !== true) {
                    if (!He(n, it("hx:poll:trigger", {triggerSpec: n}))) {
                        Zt(t, r, e)
                    }
                    qe(e, t, F(e, "hx-" + t), n)
                }
        ...
        function Oe(t, r, e) {
            if (t.tagName === "A" && Le(t) && t.target === "" || t.tagName === "FORM") {
                r.boosted = true;
                var n, i;
                if (t.tagName === "A") {
                    n = "get";
        ...
        function Te(e, t) {
            if (e.type === "submit" || e.type === "click") {
                ...
                if (v(t, 'input[type="submit"], button') && O(t, "form") !== null) {
                    return true
                }
        ...
        function He(e, t) {
            ...
            if (r) {
                try {
                    ...
                    ot(P().body, "htmx:eventFilter:error", {error: e, source: r.source});
                    return true
                }
            }
            return false
        ...
        function Me() {
            if (!Ie) {
                ...
                setInterval(function () {
                    if (Ne) {
                        Ne = false;
                        B(P().querySelectorAll("[hx-trigger='revealed'],[data-hx-trigger='revealed']"), function (e) {
                            De(e)
                        })
                    }
                }, 200)
        ...
        function Pe(s, r, n) {
            ...
            t.onerror = function (e) {
                ot(s, "htmx:wsError", {error: e, socket: t});
                Xe(s)
            };
        ...
        function Ue(l) {
            ...
            if (f) {
                l.addEventListener(Ce(l)[0].trigger, function (e) {
                    var t = j(f).webSocket;
                    var r = kt(l, f);
                    var n = Ot(l, "post");
                    var i = n.errors;
        ...
        function ze(t, e) {
            ...
            r.onerror = function (e) {
                ot(t, "htmx:sseError", {error: e, source: r});
                We(t)
            };
        ...
        function Qe(e) {
            if (e.querySelectorAll) {
                var t = Ye() ? ", a, form" : "";
                var r = e.querySelectorAll(n + t + ", [hx-sse], [data-hx-sse], [hx-ws]," + " [data-hx-ws], [hx-ext], [hx-data-ext]");
                return r
            } else {
                return []
            }
        ...
        function ct() {
            var e = P().querySelector("[hx-history-elt],[data-hx-history-elt]");
            return e || P().body
        }
        ...
        function ht(e, t, r, n) {
            ...
            while (i.length > 0) {
                try {
                    ...
                    ot(P().body, "htmx:historyCacheError", {cause: e, cache: i});
                    i.shift()
                }
            }
        }
        ...
        function gt() {
            ...
            lt(P().body, "htmx:beforeHistorySave", {path: t, historyElt: e});
            if (D.config.historyEnabled) history.replaceState({htmx: true}, P().title, window.location.href);
            ht(t, vt(e), P().title, window.scrollY)
        }
        ...
        function yt(n) {
            ...
            var i = {path: n, xhr: e};
            lt(P().body, "htmx:historyCacheMiss", i);
            e.open("GET", n, true);
            e.setRequestHeader("HX-History-Restore-Request", "true");
            e.onload = function () {
                if (this.status >= 200 && this.status < 400) {
                    lt(P().body, "htmx:historyCacheMissLoad", i);
                    ...
                    mt(r.tasks);
                    ft = n;
                    lt(P().body, "htmx:historyRestore", {path: n})
                } else {
        ...
        function xt(e) {
            ...
            if (t) {
                ...
                ft = e;
                lt(P().body, "htmx:historyRestore", {path: e})
            } else {
        ...
        function Ot(e, t) {
            ...
            var l = X(e, "hx-include");
            if (l) {
                var f = T(e, l);
                B(f, function (e) {
                    qt(r, n, o, e, a);
                    if (!v(e, "form")) {
                        B(e.querySelectorAll(Ee), function (e) {
                            qt(r, n, o, e, a)
                        })
                    }
                })
        ...
        function Dt(t, r, n) {
            ...
            if (i != null) {
                ...
                if (X(r, "hx-encoding") === "multipart/form-data" || v(r, "form") && c(r, "enctype") === "multipart/form-data") {
                    return Ht(n)
                } else {
                    return At(n)
                }
        ...
        function Pt(e, t) {
            ...
            if (t.show) {
                ...
                if (t.show === "top" && (r || i)) {
                    i = i || r;
                    i.scrollIntoView({block: "start", behavior: D.config.scrollBehavior})
                }
        ...
        function jt(e, t) {
            return Xt(e, "hx-vars", true, t)
        }

        function Bt(e, t) {
            return Xt(e, "hx-vals", false, t)
        }
        ...
        function _t(t) {
            if (t.responseURL && typeof URL !== "undefined") {
                try {
                    ...
                    ot(P().body, "htmx:badResponseUrl", {url: t.responseURL})
                }
            }
        }
        ...
        function $t(e, t, r) {
            ...
            if (r) {
                if (r instanceof Element || a(r, "String")) {
                    return Zt(e, t, null, null, {targetOverride: H(r), returnPromise: true})
                } else {
                    return Zt(e, t, H(r.source), r.event, {
                        handler: r.handler,
                        headers: r.headers,
                        values: r.values,
                ...
                return Zt(e, t, null, null, {returnPromise: true})
            }
        }
        ...
        function Zt(e, t, n, r, i) {
            ...
            if (l == null) {
                ot(n, "htmx:targetError", {target: F(n, "hx-target")});
                return
            }
            var f = j(n);
            ...
            m.withCredentials = q.withCredentials;
            m.timeout = q.timeout;
            if (R.noHeaders) {
            } else {
                for (var k in y) {
            ...
            var I = {xhr: m, target: l, requestConfig: q, pathInfo: {path: t, finalPath: A, anchor: T}};
            m.onload = function () {
                try {
                    var e = Jt(n);
                    u(n, I);
                    ...
                    if (!z(n)) {
                        ...
                        if (t) {
                            lt(t, "htmx:afterRequest", I);
                            lt(t, "htmx:afterOnLoad", I)
                        }
                    }
                    U(o);
                    d()
                } catch (e) {
                    ot(n, "htmx:onLoadError", V({error: e}, I));
                    throw e
                }
            };
            m.onerror = function () {
            ...
            B(["loadstart", "loadend", "progress", "abort"], function (t) {
                B([m, m.upload], function (e) {
                    e.addEventListener(t, function (e) {
                        lt(n, "htmx:xhr:" + t, {lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total})
                    })
                })
            });
            lt(n, "htmx:beforeSend", I);
            m.send(e === "get" ? null : Dt(m, n, C));
            return s
        }
        ...
        function Gt(a, s) {
            var u = s.xhr;
            var l = s.target;
            if (!lt(a, "htmx:beforeOnLoad", s)) return;
            ...
            if (Wt(u, /HX-Retarget:/i)) {
                s.target = P().querySelector(u.getResponseHeader("HX-Retarget"))
            }
            var c = bt(a) || f;
            var e = u.status >= 200 && u.status < 400 && u.status !== 204;
            var h = u.response;
            var t = u.status >= 400;
            var r = V({shouldSwap: e, serverResponse: h, isError: t}, s);
            if (!lt(l, "htmx:beforeSwap", r)) return;
            l = r.target;
            h = r.serverResponse;
            t = r.isError;
            s.failed = t;
                    ...
                    try {
                        ...
                        var o = function () {
                            ...
                            B(r.elts, function (e) {
                                ...
                                lt(e, "htmx:afterSettle", s)
                            });
                            if (c) {
                                var e = f || wt(a) || _t(u) || s.pathInfo.finalPath || s.pathInfo.path;
                                pt(e);
                                lt(P().body, "htmx:pushedIntoHistory", {path: e})
                            }
                            Pt(r.elts, d);
                            if (Wt(u, /HX-Trigger-After-Settle:/i)) {
                                ...
                                he(u, "HX-Trigger-After-Settle", t)
                            }
                        };
                        if (d.settleDelay > 0) {
        ...
        function rr(e) {
            if (P().readyState !== "loading") {
                ...
                P().addEventListener("DOMContentLoaded", e)
            }
        }

        function nr() {
            if (D.config.includeIndicatorStyles !== false) {
                P().head.insertAdjacentHTML("beforeend", "<style>                      ." + D.config.indicatorClass + "{opacity:0;transition: opacity 200ms ease-in;}                      ." + D.config.requestClass + " ." + D.config.indicatorClass + "{opacity:1}                      ." + D.config.requestClass + "." + D.config.indicatorClass + "{opacity:1}                    </style>")
            }
        }
